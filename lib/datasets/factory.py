...
from datasets.pascal_voc_face import pascal_voc_face
...
for year in ['2010']:
    for split in ['train', 'val', 'trainval', 'test']:
        name = 'voc_face_{}_{}'.format(year, split)
        __sets[name] = (lambda split=split, year=year: pascal_voc_face(split, year))
